...
export function Settings({
  ...
  const renderContent = () => {
    ...
    if (variant === "colored") {
      return (
        <g>
          <path d="M12 1a11 11 0 1 0 11 11A11 11 0 0 0 12 1zm0 18a7 7 0 1 1 7-7 7 7 0 0 1-7 7z" fill={getColor(1, "#10B981")}/><circle cx="12" cy="12" r="4" fill={getColor(2, "#FFDE59")}/>
        </g>
      );
    }
